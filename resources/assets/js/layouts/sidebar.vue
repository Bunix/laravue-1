            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li>
                     ...
                     <li>
                        <router-link to="/test" exact><i class="fa fa-user"></i> <span class="hide-menu">Test</span></router-link>
                    </li>
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                        <router-link to="/saude" exact><i class="fa fa-tasks"></i> <span class="hide-menu">Blutdruck etc.</span></router-link>
                    </li>
                    <li>
